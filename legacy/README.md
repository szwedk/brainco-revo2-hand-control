> ⚠️ **ARCHIVED — this is the old prototype, not the product.**
> The current product is **RoboStore Studio** (see the [root README](../README.md),
> `engine/`, `app/`). These files are kept for reference only. Don't build on them.
